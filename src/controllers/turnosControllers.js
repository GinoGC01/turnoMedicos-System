...
export class TurnosControllers {
  ...
  static async getAllSlotsByProfessionals (req, res) {
    const { id } = req.params
    try {
  ...
  static async deleteAvailableSlots (req, res) {
    const { professionalId, month, year } = req.params
  ...
  static async deleteAllSlots (req, res) {
